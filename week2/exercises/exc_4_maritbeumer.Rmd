...
squidyear_factor <- as.factor(squid$year)
squidmonth_factor <- as.factor(squid$month)
squidmaturity_stage_factor <- as.factor(squid$maturity.stage)
```
```{r}
...
contingency_table <- xtabs(~ squidyear_factor + squidmaturity_stage_factor + squidmonth_factor, data = squid)
